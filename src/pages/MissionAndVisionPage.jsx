    ...
    return (
        <main className='py-5 bg-white text-black'>
            <div className='.container'>
                <h2 className='mb-3 text-center'>Informacion</h2>
                <div className='row'>
                    <div className='col'>
                        <div className='h2 ms-5 me-3 text-start text-black'>Mision</div>
                        <div className='p-3 ms-3 me-3 bg-primary text-black'>
                    ...
                    <div className='col'>
                        <div className='h2 me-5 ms-3 text-end text-black'>Vision</div>
                        <div className='p-3 me-3 ms-3 bg-primary text-black'>
