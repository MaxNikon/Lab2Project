      ...
      <div className="container">
        <div className="row">
          <div className="col-md-4 mb-3 mb-md-0">
            ...
            <div><i className="fa-brands fa-facebook"/><a className="text-white" href="https://www.facebook.com/bancouniversitariove">@bancouniversitariove</a></div>
            <div><i className="fa-brands fa-instagram"/><a className="text-white" href="https://www.instagram.com/bancouniversitariove/">@bancouniversitariove</a></div>
            <div><i className="fa-brands fa-x-twitter"/><a className="text-white" href="https://twitter.com/bancouniversitariove">@bancouniversitariove</a></div>
          </div>
          <div className="col-md-4 mb-3 mb-md-0">
